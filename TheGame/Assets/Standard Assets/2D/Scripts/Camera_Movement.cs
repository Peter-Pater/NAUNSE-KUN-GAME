...
public class Camera_Movement : MonoBehaviour { // This scripts moves the camera
    ...
    public GameObject storeHouse2nd;
	...
	void UpdateSceneObj(){
        ...
        }else if(currentScene == General_SceneList.BROKENBRIDGE){
            currentSceneObj = brokenBridge;
        ...
        }else if (currentScene == General_SceneList.STOREHOUSE2ND){
            currentSceneObj = storeHouse2nd;
        }
	}
